...
syn match cMathOperator display "[-+*%=<>|.,&!^~:]" 	" C math operators 
syn match cPointerOperator display "->/|/." 			" C pointer operators 
syn match cLogicalOperator display "[!<>]=/=" 			" C logical operators - boolean results 
...
syn keyword MY_STL std vector map multimap list deque set multiset string queue stack
hi MY_STL  guifg=#ffff00
